...
INSERT INTO items (name, description, image, price) VALUES
    ('Electric Guitar', 'A standard electric guitar suitable for beginners and intermedlate placers.', '/electric-guitar.png', 120.00),
...
ALTER USER postgres WITH NOCREATEROLE;
ALTER USER postgres WITH NOINHERIT;
ALTER USER postgres WITH NOCREATEDB;
...
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE purchases TO postgres;
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE receipts TO postgres;
GRANT SELECT, INSERT ON TABLE sessions TO postgres;
GRANT SELECT ON TABLE users TO postgres;
